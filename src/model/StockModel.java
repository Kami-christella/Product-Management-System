...
public class StockModel {
    ...
    public StockModel(String pname, int pid, int quantity, String ddate, String edate, int cp, int sp, String efname, String elname, String duty,String password, int salary) {
        this.pname = pname;
        this.pid = pid;
    ...
    public StockModel(int Eid) {
        this.Eid = Eid;
    }

    public StockModel(String ADID, String names, String adusername, String adpassword) {
        this.ADID = ADID;
        this.names = names;
    ...
    public StockModel(String updDate, String workUpdates, String opNames, int telNummber, String email, String opinion) {
