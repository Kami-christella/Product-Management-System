...
public class searchSelAdmin extends javax.swing.JFrame {
    ...
    public searchSelAdmin() {
      ...
      public Connection getConnection(){
        ...
        public ArrayList<StockModel> ListAdmins(String valToSearc)
    {
       ArrayList<StockModel> AdminsList=new  ArrayList<StockModel>();
         Statement st;
       //  ResultSet rs;
                 try{
                     Connection con=getConnection();
                     st=con.createStatement();
                     String searchQuery="SELECT * FROM `admins` WHERE CONCAT ( `ADID`, `Names`, `adusername`, `adpassword`) LIKE '%"+valToSearc+"%'";
       ...
       return AdminsList;
        ...
        ArrayList<StockModel> sm=ListAdmins(searchAdmTxt.getText());
