...
public class searchSelProd extends javax.swing.JFrame {
    ...
    public ArrayList<StockModel> ListProducts(String valToSearc)
    {
       ArrayList<StockModel> ProductsList=new  ArrayList<StockModel>();
         Statement st;
       //  ResultSet rs;
                 try{
                     Connection con=getConnection();
                     st=con.createStatement();
                     String searchQuery="SELECT * FROM `product` WHERE CONCAT ( `pid`, `pname`, `Quantity`, `deliverydate`, `expirydate`, `cp`, `sp`) LIKE '%"+valToSearc+"%'";
                      ResultSet rs=st.executeQuery(searchQuery);
                     StockModel sm;
                     
                     while(rs.next()){
                         sm=new StockModel();
                         sm.setPid(rs.getInt("pid"));
                         sm.setPname(rs.getString("pname"));
                         sm.setQuantity(rs.getInt("Quantity"));
                         sm.setDdate(rs.getString("deliverydate"));
                         sm.setEdate( rs.getString("expirydate"));
    ...
    public void findUser(){
        ArrayList<StockModel> sm=ListProducts(searchIdTxt.getText());
